...
// po to blokada przed d�wi�kiem
// cof wskazuje na pole na planszy, które może być cofnięte
int l = 0, b, p = 0, k = 0, po = 0, cof = 0, pom = 0;

/* 
funkcja która posiada powtarzające się mechanizmy
pokazywania stanu końca gry po kliknięciu jakiegoś
...
void __fastcall TForm1::sprawdz()
{
      ...
      && p == 0 )
  {
    ...
    char *w;
    if (kto == 'x')
      w = "Wygrywa k�ko!  (naci�nij przycisk ,Od Nowa' lub gra->od pocz�tku, by zacz�� ponownie gr�.)";
    else
      w = "Wygrywa krzy�yk!  (naci�nij przycisk ,Od Nowa' lub gra->od pocz�tku, by zacz�� ponownie gr�)";
  ...
  if (p == 1)
  {
    // kiedy gra niezresetowana, a dalej można klikać
    Label3->Caption = "Stan: zresetuj plansz�";
    pole1->Enabled = false;
    pole2->Enabled = false;
    pole3->Enabled = false;
    pole4->Enabled = false;
      ...
      p == 0)
  {
    ...
    tura->Visible = false;
    Button3->Enabled = false;
    Application->MessageBox("remis!!!  (naci�nij przycisk ,Od Nowa' lub gra->od pocz�tku, by zacz�� ponownie gr�)", "Koniec Gry", MB_OK);
    sndPlaySound("snd/suck.wav", SND_ASYNC);
  }
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::FormClose(TObject *Sender, TCloseAction &Action)
{
  ...
  if (k == 1)
  {
    if (Application->MessageBox(
            "Czy chcesz zamkn�� program? (Utracisz wtedy wszystkie obecne dane gry.)", "Zako�czenie gry",
...
void __fastcall TForm1::github() {
  ...
  Application->MessageBox(
      "Dzi�kuj� za odwiedzenie mojego githuba ;)", "Podzidzi�kowania",
      MB_OK);
  sndPlaySound("snd/suck.wav", SND_ASYNC);
}